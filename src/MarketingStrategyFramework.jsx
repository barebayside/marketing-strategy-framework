...
const PRODUCT_TYPES = [
  ...
  },
  {
    ...
    audience_fit: {
      ...
      community:    { score: "strong",   label: "STRONG FIT",   reason: "Local community groups (Facebook community groups, Nextdoor, local Instagram) are a primary acquisition channel for local businesses — especially at zero or low budgets. Posting before/after results, answering local questions, and building neighbourhood-level trust drives direct enquiries. Geographic proximity means even a small audience converts at high rates because they can actually use you." },
      owned:        { score: "strong",   label: "STRONG FIT",   reason: "Email and SMS are critical for local service businesses — rebooking reminders at optimal intervals, seasonal promotions, and review request sequences drive repeat revenue and referrals. For acquisition, a simple 'refer a friend' email to existing customers is one of the highest-converting local marketing tactics available at any budget." },
    },
            ...
            <div>
              ...
              <div style={{ marginBottom: 48 }}>
                <div className="email-cta-box" style={{
                  ...
                  {/* Desktop: form left | divider | benefits right. Mobile: stacked */}
                  <div className="cta-split-layout" style={{ display: "flex", gap: 0, alignItems: "stretch" }}>
